...
class VCU108MIGIODDR(depth : BigInt) extends Bundle {
  require((depth<=0x80000000L),"VCU108MIGIODDR supports upto 2GB depth configuraton")
...
class vcu108mig(depth : BigInt)(implicit val p:Parameters) extends BlackBox
{
  ...
  // Vivado 2025.2 lists the VCU108 EDY4016AABG-DR-F-D component as EDY4016AABG-DR-F.
